...
export function LiftStats({ lift, history }) {
  ...
  const cadence =
    "De actuele status van een lift is nooit ouder dan 15 minuten. Statistieken worden echter per dag in de avond berekend. Een storing die tussen twee metingen begint én weer voorbij is, zien we niet.";
